...
function withCookie(sessionId: string, existing: string): Record<string, string> { return existing ? {} : { 'set-cookie': `${cookieName}=${sessionId}; Path=/; Max-Age=31536000; SameSite=Lax; Secure` }; }
